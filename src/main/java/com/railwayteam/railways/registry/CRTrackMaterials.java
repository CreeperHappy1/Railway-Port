...
public class CRTrackMaterials {
    public static final TrackMaterial
        ACACIA = make(Railways.asResource("acacia"))
            ...
            .particle(Identifier.withDefaultNamespace("block/acacia_planks"))
        ...
        BIRCH = make(Railways.asResource("birch"))
            ...
            .particle(Identifier.withDefaultNamespace("block/birch_planks"))
        ...
        CRIMSON = make(Railways.asResource("crimson"))
            ...
            .particle(Identifier.withDefaultNamespace("block/crimson_planks"))
        ...
        DARK_OAK = make(Railways.asResource("dark_oak"))
            ...
            .particle(Identifier.withDefaultNamespace("block/dark_oak_planks"))
        ...
        JUNGLE = make(Railways.asResource("jungle"))
            ...
            .particle(Identifier.withDefaultNamespace("block/jungle_planks"))
        ...
        OAK = make(Railways.asResource("oak"))
            ...
            .particle(Identifier.withDefaultNamespace("block/oak_planks"))
        ...
        SPRUCE = make(Railways.asResource("spruce"))
            ...
            .particle(Identifier.withDefaultNamespace("block/spruce_planks"))
        ...
        WARPED = make(Railways.asResource("warped"))
            ...
            .particle(Identifier.withDefaultNamespace("block/warped_planks"))
        ...
        BLACKSTONE = make(Railways.asResource("blackstone"))
            ...
            .particle(Identifier.withDefaultNamespace("block/blackstone"))
        ...
        MANGROVE = make(Railways.asResource("mangrove"))
            ...
            .particle(Identifier.withDefaultNamespace("block/mangrove_planks"))
        ...
        CHERRY = make(Railways.asResource("cherry"))
            ...
            .particle(Identifier.withDefaultNamespace("block/cherry_planks"))
        ...
        BAMBOO = make(Railways.asResource("bamboo"))
            ...
            .particle(Identifier.withDefaultNamespace("block/bamboo_block"))
        ...
        STRIPPED_BAMBOO = make(Railways.asResource("stripped_bamboo"))
            ...
            .particle(Identifier.withDefaultNamespace("block/bamboo_planks"))
        ...
        ENDER = make(Railways.asResource("ender"))
            ...
            .particle(Identifier.withDefaultNamespace("block/end_stone"))
        ...
        TIELESS = make(Railways.asResource("tieless"))
            ...
            .particle(Identifier.withDefaultNamespace("block/glass"))
    ...
    public static class CRTrackType extends TrackType {
        ...
        public CRTrackType(Identifier id, TrackBlockFactory factory) {
            super(id, factory);
        }
    }
