...
public class ObjModelBuilder<T extends ModelBuilder<T>> extends CustomLoaderBuilder<T> {
    ...
    private static final Identifier FORGE_OBJ = Identifier.fromNamespaceAndPath("forge", "obj");
    private static final Identifier PORTING_LIB_LOADER = Identifier.fromNamespaceAndPath("porting_lib", "loader");
    private static final Identifier PORTING_LIB_OBJ = Identifier.fromNamespaceAndPath("porting_lib", "obj");
